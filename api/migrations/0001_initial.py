    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('situacao', models.CharField(choices=[('Aberto', 'Aberto'), ('Em Pesquisa', 'Em Pesquisa'), ('Aguardando Publicação', 'Aguardando Publicacao'), ('Publicado', 'Publicado'), ('Em Contratação', 'Em Contratacao'), ('Adjudicado/Homologado', 'Adjudicado Homologado'), ('Revogado/Cancelado', 'Revogado Cancelado')], default='Em Pesquisa', max_length=50)),
